---
title: "L11: Nesting and Crossing II"
author: "EJC"
...
\vspace{\baselineskip}
  ...
  - 'Nesting and crossing' section in LMM chapter, **Course notes**
...
**Carry-over effects**:  One limitation of crossover designs is that receiving one treatment first may have an \textcm{influence} on subjects' responses in the \textcm{subsequent period} in which they receive the other treatment.
...
- In more complex models, it may be easier to estimate carryover effects by examining interactions.  Including a term in the model for treatment used in the previous period may help in estimating (differential) carryover effects.
