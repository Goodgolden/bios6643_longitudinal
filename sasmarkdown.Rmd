...
```{r datastep2, engine="sashtml", collectcode=TRUE, engine.path="C:/Program Files/SASHome/SASFoundation/9.4/sas.exe", engine.opts="-nosplash -ls 75"}
...
```{r, engine="sashtml", engine.path="C:/Program Files/SASHome/SASFoundation/9.4/sas.exe", engine.opts=sasopts, collectcode=T}
...
```{r, engine="sashtml", engine.path="C:/Program Files/SASHome/SASFoundation/9.4/sas.exe", engine.opts=sasopts}
proc means;
  var scrap speed;
```
